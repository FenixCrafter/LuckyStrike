    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ReservationLanes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ReservationLanes_Reservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                name: "LaneReservationTimes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    ReservationLaneId = table.Column<int>(type: "int", nullable: false),
                    Time = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LaneReservationTimes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LaneReservationTimes_ReservationLanes_ReservationLaneId",
                        column: x => x.ReservationLaneId,
                        principalTable: "ReservationLanes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LaneReservationTimes_ReservationLaneId",
                table: "LaneReservationTimes",
                column: "ReservationLaneId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReservationLanes_ReservationId",
                table: "ReservationLanes",
